...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Student Update Password</a>
    ...
    <div class="container mt-5">
        <h2 class="mb-4 text-center">Student Change Password</h2>
        <form id="up" method="POST">
            ...
            <div class="mb-3">
                <label for="student_password_confirm" class="form-label">Student Password Confirm</label>
...
function upd_pass()
{
    ...
    form.addEventListener('submit', function(e){
        ...
        fetch(`http://127.0.0.1:8000/api/upd_stu_pass/${id}`, {
            method:"POST",
